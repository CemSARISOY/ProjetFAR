...
int \mbox{\hyperlink{serveur_8c_a86db96a3733386e3701a7008765f51cb}{has\+Space}} (char $\ast$str)
\begin{DoxyCompactList}\small\item\em fonction testant si la chaine de caractère possède un espace \end{DoxyCompactList}\item 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{serveur_8c_a86db96a3733386e3701a7008765f51cb}\label{serveur_8c_a86db96a3733386e3701a7008765f51cb}} 
\index{serveur.c@{serveur.c}!hasSpace@{hasSpace}}
\index{hasSpace@{hasSpace}!serveur.c@{serveur.c}}
\doxysubsubsection{\texorpdfstring{hasSpace()}{hasSpace()}}
{\footnotesize\ttfamily int has\+Space (\begin{DoxyParamCaption}\item[{char $\ast$}]{str }\end{DoxyParamCaption})}



fonction testant si la chaine de caractère possède un espace 


\begin{DoxyParams}{Paramètres}
{\em str} & la chaine de caracter à tester \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
1 si la chaine de caractère possède au moins un espace, 0 sinon 
\end{DoxyReturn}
